  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Nav.navTypes.create() instead.
        "prototype$__create__navTypes": {
          url: urlBase + "/navs/:id/navTypes",
          method: "POST"
        },

        // INTERNAL. Use Nav.navTypes.update() instead.
        "prototype$__update__navTypes": {
          url: urlBase + "/navs/:id/navTypes",
          method: "PUT"
        },

        // INTERNAL. Use Nav.navTypes.destroy() instead.
        "prototype$__destroy__navTypes": {
          url: urlBase + "/navs/:id/navTypes",
          method: "DELETE"
        },
        ...
        // INTERNAL. Use NavType.navs.findById() instead.
        "::findById::navType::navs": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/navTypes/:id/navs/:fk",
          method: "GET"
        },

        // INTERNAL. Use NavType.navs.destroyById() instead.
        "::destroyById::navType::navs": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/navTypes/:id/navs/:fk",
        ...
        // INTERNAL. Use NavType.navs.updateById() instead.
        "::updateById::navType::navs": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/navTypes/:id/navs/:fk",
        ...
        // INTERNAL. Use NavType.navs() instead.
        "::get::navType::navs": {
          isArray: true,
          url: urlBase + "/navTypes/:id/navs",
          method: "GET"
        },

        // INTERNAL. Use NavType.navs.create() instead.
        "::create::navType::navs": {
          url: urlBase + "/navTypes/:id/navs",
          method: "POST"
        },

        // INTERNAL. Use NavType.navs.createMany() instead.
        "::createMany::navType::navs": {
          isArray: true,
          url: urlBase + "/navTypes/:id/navs",
          method: "POST"
        },

        // INTERNAL. Use NavType.navs.destroyAll() instead.
        "::delete::navType::navs": {
          url: urlBase + "/navTypes/:id/navs",
          method: "DELETE"
        },

        // INTERNAL. Use NavType.navs.count() instead.
        "::count::navType::navs": {
          url: urlBase + "/navTypes/:id/navs/count",
          method: "GET"
        },
      }
    );
    ...
    */
     ...
     * @header lbServices.Nav.navTypes
     * @object
     * @description
     *
     * The object `Nav.navTypes` groups methods
     * manipulating `NavType` instances related to `Nav`.
     *
     * Call {@link lbServices.Nav#navTypes Nav.navTypes()}
     * to query all related instances.
     */
         ...
         * @description
         *
         * Fetches hasOne relation navTypes.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        /**
         * @ngdoc method
         * @name lbServices.Nav.navTypes#create
         * @methodOf lbServices.Nav.navTypes
         *
         * @description
         *
         * Creates a new instance in navTypes of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * </em>
         */
        R.navTypes.create = function() {
          var TargetResource = $injector.get("NavType");
          var action = TargetResource["::create::nav::navTypes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Nav.navTypes#createMany
         * @methodOf lbServices.Nav.navTypes
         *
         * @description
         *
         ...
         * </em>
         */
        R.navTypes.createMany = function() {
          var TargetResource = $injector.get("NavType");
          var action = TargetResource["::createMany::nav::navTypes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Nav.navTypes#destroy
         * @methodOf lbServices.Nav.navTypes
         *
         * @description
         *
         * Deletes navTypes of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * This method returns no data.
         */
        R.navTypes.destroy = function() {
          var TargetResource = $injector.get("NavType");
          var action = TargetResource["::destroy::nav::navTypes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Nav.navTypes#update
         * @methodOf lbServices.Nav.navTypes
         *
         * @description
         *
         * Update navTypes of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * </em>
         */
        R.navTypes.update = function() {
          var TargetResource = $injector.get("NavType");
          var action = TargetResource["::update::nav::navTypes"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Nav.navTypes.createMany() instead.
        "::createMany::nav::navTypes": {
          isArray: true,
          url: urlBase + "/navs/:id/navTypes",
          method: "POST"
        },
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.NavType.navs
     * @header lbServices.NavType.navs
     * @object
     * @description
     *
     * The object `NavType.navs` groups methods
     * manipulating `Nav` instances related to `NavType`.
     *
     * Call {@link lbServices.NavType#navs NavType.navs()}
     * to query all related instances.
     */
        ...
        R.navs = function() {
          ...
          var action = TargetResource["::get::navType::navs"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.NavType.navs#count
         * @methodOf lbServices.NavType.navs
         *
         * @description
         *
         * Counts navs of navType.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.navs.count = function() {
          var TargetResource = $injector.get("Nav");
          var action = TargetResource["::count::navType::navs"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.NavType.navs#create
         * @methodOf lbServices.NavType.navs
         *
         * @description
         *
        ...
        R.navs.create = function() {
          var TargetResource = $injector.get("Nav");
          var action = TargetResource["::create::navType::navs"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.NavType.navs#createMany
         * @methodOf lbServices.NavType.navs
         *
         * @description
         *
        ...
        R.navs.createMany = function() {
          var TargetResource = $injector.get("Nav");
          var action = TargetResource["::createMany::navType::navs"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.NavType.navs#destroyAll
         * @methodOf lbServices.NavType.navs
         *
         * @description
         *
        ...
        R.navs.destroyAll = function() {
          var TargetResource = $injector.get("Nav");
          var action = TargetResource["::delete::navType::navs"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.NavType.navs#destroyById
         * @methodOf lbServices.NavType.navs
         *
         * @description
         *
        ...
        R.navs.destroyById = function() {
          var TargetResource = $injector.get("Nav");
          var action = TargetResource["::destroyById::navType::navs"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.NavType.navs#findById
         * @methodOf lbServices.NavType.navs
         *
         * @description
         *
        ...
        R.navs.findById = function() {
          var TargetResource = $injector.get("Nav");
          var action = TargetResource["::findById::navType::navs"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.NavType.navs#updateById
         * @methodOf lbServices.NavType.navs
         *
         * @description
         *
        ...
        R.navs.updateById = function() {
          var TargetResource = $injector.get("Nav");
          var action = TargetResource["::updateById::navType::navs"];
          return action.apply(R, arguments);
        };
